...
TEST(TimeSeqJsonScriptIf, ParseShouldFailWithMultipleOperators) {
	...
	json["component-pool"] = {
		{ "actions", json::array({
			...
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "eq", doubleValueArray }, { "lt", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "eq", doubleValueArray }, { "lte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "eq", doubleValueArray }, { "gt", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "eq", doubleValueArray }, { "gte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "eq", doubleValueArray }, { "and", dualIf } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "eq", doubleValueArray }, { "or", dualIf } } } },

			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "ne", doubleValueArray }, { "lt", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "ne", doubleValueArray }, { "lte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "ne", doubleValueArray }, { "gt", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "ne", doubleValueArray }, { "gte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "ne", doubleValueArray }, { "and", dualIf } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "ne", doubleValueArray }, { "or", dualIf } } } },

			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lt", doubleValueArray }, { "lte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lt", doubleValueArray }, { "gt", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lt", doubleValueArray }, { "gte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lt", doubleValueArray }, { "and", dualIf } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lt", doubleValueArray }, { "or", dualIf } } } },

			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lte", doubleValueArray }, { "gt", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lte", doubleValueArray }, { "gte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lte", doubleValueArray }, { "and", dualIf } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "lte", doubleValueArray }, { "or", dualIf } } } },

			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "gt", doubleValueArray }, { "gte", doubleValueArray } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "gt", doubleValueArray }, { "and", dualIf } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "gt", doubleValueArray }, { "or", dualIf } } } },

			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "gte", doubleValueArray }, { "and", dualIf } } } },
			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "gte", doubleValueArray }, { "or", dualIf } } } },

			{ { "id", "action-1" }, { "trigger", "trigger-name" }, { "if", { { "and", dualIf }, { "or", dualIf } } } },
		}) }
	};
