...
void initializeSolimOutputOctaverModule(SolimOutputOctaverModule& solimOutputOctaverModule) {
	for (int i = 0; i < SolimOutputOctaverModule::LightId::NUM_LIGHTS; i++) {
...
void expectConnected(SolimOutputOctaverModule& solimOutputOctaverModule, bool connected) {
	if (connected) {
		EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_CONNECTED].getBrightness(), 1.f, 0.0001f);
		EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_NOT_CONNECTED].getBrightness(), 0.f, 0.0001f);
	} else {
		EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_CONNECTED].getBrightness(), 0.f, 0.0001f);
		EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_NOT_CONNECTED].getBrightness(), 1.f, 0.0001f);
	}
}
...
TEST(SolimOutputOctaverTest, ShouldLightReplaceOriginalLedsBasedOnParams) {
	...
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 1].setValue(1.0f);
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 3].setValue(1.0f);
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 5].setValue(1.0f);
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 7].setValue(1.0f);

	solimOutputOctaverModule.draw(widget::Widget::DrawArgs());

	for (int i = 0; i < 8; i += 2) {
		// Even lights should be turned off, uneven ones turned on
		EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + i].getBrightness(), 0.f, 0.0001f);
		EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + i + 1].getBrightness(), 1.f, 0.0001f);
	}
}
...
TEST(SolimOutputOctaverTest, ShouldLightReplaceOriginalLedsBasedOnOutputs) {
	...
	solimOutputOctaverModule.inputs[SolimOutputOctaverModule::InputId::IN_REPLACE_ORIGINAL + 2].channels = 1;
	solimOutputOctaverModule.inputs[SolimOutputOctaverModule::InputId::IN_REPLACE_ORIGINAL + 2].setVoltage(1.f);
	solimOutputOctaverModule.inputs[SolimOutputOctaverModule::InputId::IN_REPLACE_ORIGINAL + 4].channels = 1;
	solimOutputOctaverModule.inputs[SolimOutputOctaverModule::InputId::IN_REPLACE_ORIGINAL + 4].setVoltage(0.f);
	solimOutputOctaverModule.inputs[SolimOutputOctaverModule::InputId::IN_REPLACE_ORIGINAL + 6].channels = 1;
	solimOutputOctaverModule.inputs[SolimOutputOctaverModule::InputId::IN_REPLACE_ORIGINAL + 6].setVoltage(1.f);

	solimOutputOctaverModule.draw(widget::Widget::DrawArgs());

	for (int i = 0; i < 8; i++) {
		if (i == 2 || i == 6) {
			EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + i].getBrightness(), 1.f, 0.0001f);
		} else {
			EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + i].getBrightness(), 0.f, 0.0001f);
		}
	}
...
TEST(SolimOutputOctaverTest, ShouldOnlyUseParamForLightReplaceOriginalIfOutputIsNotConnected) {
	...
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 1].setValue(1.0f);
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 2].setValue(1.0f);
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 4].setValue(1.0f);
	solimOutputOctaverModule.params[SolimOutputOctaverModule::ParamId::PARAM_REPLACE_ORIGINAL + 6].setValue(1.0f);
	...
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 0].getBrightness(), 0.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 1].getBrightness(), 1.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 2].getBrightness(), 1.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 3].getBrightness(), 0.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 4].getBrightness(), 0.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 5].getBrightness(), 0.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 6].getBrightness(), 1.f, 0.0001f);
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_REPLACE_ORIGINAL + 7].getBrightness(), 0.f, 0.0001f);
}
...
TEST(SolimOutputOctaverTest, ShouldLightUpResortWhenPressed) {
	...
	EXPECT_NEAR(solimOutputOctaverModule.lights[SolimOutputOctaverModule::LightId::LIGHT_RESORT].getBrightness(), 1.f, 0.0001f);
}
