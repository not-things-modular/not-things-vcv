...
* Added `gate-high-duration` property on [gate actions](TIMESEQ-SCRIPT-JSON.md#gate-actions) as a constant-length alternative for the existing relative `gate-high-ratio` property.
