...
![Solim main and expander modules](./solim-modules-separated-light.png)
...
![SL-I and SL-O modules](./sl-io-light.png)
### Expander chaining
...
![SL-I and SL-O connections](./sl-io-pairing.png)
...
![Solim Input Octaver](./solim-input-octaver-light.png)
### Expander chaining
...
![Solim Output Octaver](./solim-output-octaver-light.png)
### Expander chaining
